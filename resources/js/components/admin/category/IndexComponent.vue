...
export default {
    ...
    methods: {
        ...
        pagination (page = 1) {
            axios.post('http://localhost:8876/api/admin/categories', {
                'like': this.query,
                'page': page
            }).
            then( res => {
        ...
        show (id) {
            window.location.href = `http://localhost:8876/admin/categories/${id}`
        },
        create () {
            window.location.href = 'http://localhost:8876/admin/categories/create'
        }
