...
export default {
    ...
    methods: {
        ...
        pagination (page = 1) {
            axios.post('http://localhost:8876/api/admin/posts', {
                'like': this.query,
                'page': page
            }).
            then( res => {
        ...
        show (id) {
            window.location.href = `http://localhost:8876/admin/posts/${id}`
        },
        create () {
            window.location.href = 'http://localhost:8876/admin/posts/create'
        }
