                    ...
                    <section class="edica-about-vision py-5">
                        <div class="row">
                            <div class="col-md-6 pb-3 pb-md-0 mb-4 mb-md-0" data-aos="fade-right" data-aos-delay="200">
                                <img src="../../../../public/assets/images/about-vision.png" alt="vision" class="img-fluid">
                            </div>
                    ...
                    <section class="edica-about-goal py-5 mb-5">
                        <div class="row">
                            ...
                            <div class="col-md-6" data-aos="fade-left">
                                <img src="../../../../public/assets/images/about-goal.png" alt="goal" class="img-fluid">
                            </div>
                        </div>
                    </section>
                    <section class="edica-about-clients pb-5 mb-5">
                        ...
                        <div class="row py-4" data-aos="fade-up">
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_1@2x.png" alt="client logo" class="img-fluid" >
                            </div>
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_2@2x.png" alt="client logo"  class="img-fluid">
                            </div>
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_3@2x.png" alt="client logo" class="img-fluid">
                            </div>
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_4@2x.png" alt="client logo"  class="img-fluid">
                            </div>
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_5@2x.png" alt="client logo"  class="img-fluid">
                            </div>
                            <div class="col-6 col-md-2 mb-4 mb-md-0">
                                <img src="../../../../public/assets/images/Partner_6@2x.png" alt="client logo"  class="img-fluid">
                            </div>
                        </div>
                    </section>
