                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            ...
                            <div class="col-md-6 carousel-img-wrapper">
                                <img src="../../../../public/assets/images/Slider_1.png" alt="carousel-img" class="img-fluid" width="350px">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" data-aos="fade-up-left">
                        <img src="../../../../public/assets/images/phone-copy.png" width="468px" alt="about" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
        <section class="edica-landing-section edica-landing-clients">
            <div class="container">
                ...
                <div class="partners-wrapper">
                    <img src="../../../../public/assets/images/Partner_1.png" alt="client logo" data-aos="flip-right" data-aos-delay="250">
                    <img src="../../../../public/assets/images/Partner_2.png" alt="client logo" data-aos="flip-right" data-aos-delay="500">
                    <img src="../../../../public/assets/images/Partner_3.png" alt="client logo" data-aos="flip-right" data-aos-delay="750">
                    <img src="../../../../public/assets/images/Partner_4.png" alt="client logo" data-aos="flip-right" data-aos-delay="1000">
                    <img src="../../../../public/assets/images/Partner_5.png" alt="client logo" data-aos="flip-right" data-aos-delay="1250">
                    <img src="../../../../public/assets/images/Partner_6.png" alt="client logo" data-aos="flip-right" data-aos-delay="1500">
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 landing-service-card" data-aos="fade-right">
                        <img src="../../../../public/assets/images/picture.svg" alt="card img" class="img-fluid service-card-img">
                    ...
                    <div class="col-md-6 landing-service-card" data-aos="fade-left">
                        <img src="../../../../public/assets/images/internet.svg" alt="card img" class="img-fluid service-card-img">
                        <h4 class="service-card-title">Secure and Reliable</h4>
                        <p class="service-card-description">He has led a remarkable campaign, defying the traditional mainstream parties courtesy of his En Marche! movement. For many, however, the.</p>
                    </div>
                    <div class="col-md-6 landing-service-card" data-aos="fade-right">
                        <img src="../../../../public/assets/images/goal.svg" alt="card img" class="img-fluid service-card-img">
                        <h4 class="service-card-title">Fast. Instantly.</h4>
                        <p class="service-card-description">He has led a remarkable campaign, defying the traditional mainstream parties courtesy of his En Marche! movement. For many, however, the.</p>
                    </div>
                    <div class="col-md-6 landing-service-card" data-aos="fade-left">
                        <img src="../../../../public/assets/images/chat-bubble.svg" alt="card img" class="img-fluid service-card-img">
            ...
            <div class="container">
                <div id="edicaLandingTestimonialCarousel" class="carousel slide landing-testimonial-carousel" data-ride="carousel">
                    <div class="text-center py-4">
                        <img src="../../../../public/assets/images/quote.svg" alt="quote">
                    </div>
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="0">
                            <img src="../../../../public/assets/images/oval-copy-3.png" alt="avatar">
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="1">
                            <img src="../../../../public/assets/images/oval-copy-4.png" alt="avatar">
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="2" class="active">
                            <img src="../../../../public/assets/images/oval.png" alt="avatar">
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="3">
                            <img src="../../../../public/assets/images/oval-copy.png" alt="avatar">
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
                        ...
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="4">
                            <img src="../../../../public/assets/images/oval-copy-2.png" alt="avatar">
                            <div class="user-details">
                                <h6>Gabie Sheber</h6>
                                <p>Developer</p>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 landing-blog-post" data-aos="fade-right">
                        <img src="../../../../public/assets/images/rectangle.png" alt="blog post" class="blog-post-thumbnail">
                    ...
                    <div class="col-md-4 landing-blog-post" data-aos="fade-up">
                        <img src="../../../../public/assets/images/rectangle-copy.png" alt="blog post" class="blog-post-thumbnail">
                        <p class="blog-post-category">Blog post</p>
                        <h4 class="blog-post-title">Check our latest blog post for more update.</h4>
                        <a href="#!" class="blog-post-link">Learn more</a>
                    </div>
                    <div class="col-md-4 landing-blog-post" data-aos="fade-left">
                        <img src="../../../../public/assets/images/rectangle-copy-2.png" alt="blog post" class="blog-post-thumbnail">
                        <p class="blog-post-category">Blog post</p>
                        <h4 class="blog-post-title">Check our latest blog post for more update.</h4>
                        <a href="#!" class="blog-post-link">Learn more</a>
                    </div>
